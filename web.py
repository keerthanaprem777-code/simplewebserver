...
<head>
  <style>
    body {
      ...
      background: linear-gradient(to bottom, #000000, #363b77bb);
      padding: 20px;
    }
    .layer {
      background: #fff;
...
<body>
  ...
  <h1 style="text-align:center; color:#ffffff;"><i>List of Protocols in TCP/IP Protocol Suite</i></h1>
  ...
  <p align="right">DEVOLOPED BY: keerthana p</p>
